...
import { RequestMessage } from 'src/app/core/models/requestMessage';
...
@Component({
  selector: 'app-luc-draftman',
  templateUrl: './luc-draftman.component.html',
  styleUrls: ['./luc-draftman.component.css']
})
export class LucDraftmanComponent implements OnInit {
  ...
  save() {
    this.objLUC.format = LUCFormat.Draftman;
