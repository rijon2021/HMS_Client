...
@Component({
  selector: 'app-rpt-bc-case-inspection-print',
  templateUrl: './rpt-bc-case-inspection-print.component.html',
  styleUrls: ['./rpt-bc-case-inspection-print.component.scss']
})
export class RptBcCaseInspectionPrintComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.objFileMasterWithDetails.inspectionDetailsBCSPCase = new InspectionDetailsBCSPCase();
    ...
    this.applicationFileMasterService.getByIDWithDetails(fileMasterID).subscribe(
      (res) => {
        if (res) {
          ...
          if (this.objFileMasterWithDetails != null && this.objFileMasterWithDetails.inspectionDetailsBCSPCase != null) {
            this.objFileMasterWithDetails.inspectionDetailsBCSPCase.investigationOfficerSignature =
              "data:image/png;base64," + this.objFileMasterWithDetails.inspectionDetailsBCSPCase.investigationOfficerSignature;
            this.objFileMasterWithDetails.inspectionDetailsBCSPCase.deptHeadSignature =
              "data:image/png;base64," + this.objFileMasterWithDetails.inspectionDetailsBCSPCase.deptHeadSignature;
          }
        }
      }
    );
