...
(function ($) {
	...
	'<div id="lcl_wrap" class="lcl_pre_show lcl_pre_first_el lcl_first_sizing lcl_is_resizing">'+
		'<div id="lcl_window">'+
			...
			'<div id="lcl_nav_cmd">'+
				'<div class="lcl_icon lcl_prev" title="previous"><i class="bx bx-chevron-left"></i></div>'+
				'<div class="lcl_icon lcl_play"><i class="bx bx-play"></i></div>'+
				'<div class="lcl_icon lcl_next" title="next"><i class="bx bx-chevron-right"></i></div>'+
				'<div class="lcl_icon lcl_counter"></div>'+

				'<div class="lcl_icon lcl_right_icon lcl_close" title="close"><i class="bx bx-x"></i></div>'+
				
				'<div class="lcl_icon lcl_right_icon lcl_fullscreen" title="toggle fullscreen"><i class="bx bx-fullscreen"></i></div>'+
				'<div class="lcl_icon lcl_right_icon lcl_txt_toggle" title="toggle text"></div>'+
				'<div class="lcl_icon lcl_right_icon lcl_download" title="download"></div>'+
				'<div class="lcl_icon lcl_right_icon lcl_thumbs_toggle" title="toggle thumbnails"><i class="bx bx-fullscreen"></i></div>'+
